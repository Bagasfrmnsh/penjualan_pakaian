...
@endif</a>
<div class="d-flex">
<a href="{{route('transaksi.show' ,$data->id)}}" class="btn btn-outline-warning mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
...
@csrf
@method('delete') <button type="submit" class="btn btn-outline-danger delete-confirm"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
